...
program.on('--help', function(){
  ...
  console.log('')
  console.log(' - TF_AGENT_URL')
  console.log(`   Current value: ${process.env.TF_AGENT_URL || 'not set'}`)
  ...
  console.log(' - TIDEFLOWIO_AGENT_TOKEN')
  console.log(`   Current value: ${process.env.TIDEFLOWIO_AGENT_TOKEN || 'not set'}`)
